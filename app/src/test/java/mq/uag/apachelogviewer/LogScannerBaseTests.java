...
public class LogScannerBaseTests  {
    ...
    public  void Test_rawLogLineToEntry_BaseFunc_numIP()
    {
        ...
        LogEntry le = (LogEntry) LogManager.rawLogLineToEntry(testData[0]);
    ...
    {
        LogEntry le = (LogEntry) LogManager.rawLogLineToEntry(testData[2]);
        assertThat("Ne retourne pas un LogEntry !!",le,instanceOf(LogEntry.class));
    ...
    {
        LogEntry le = (LogEntry) LogManager.rawLogLineToEntry(errData);
    ...
    public void Test_rawLogLineToEntry_BaseFunc_ArrayOfLogEntryToArrayOfStrings() {
        ...
        {
            testList.add( (LogEntry) LogManager.rawLogLineToEntry(s));
        }

        endTestList = (List<String>) LogManager.getDisplayList(testList);
